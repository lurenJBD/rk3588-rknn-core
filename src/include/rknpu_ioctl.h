 ...
 * @obj_addr: zero-extended GEM handle token.
 ...
 * @obj_addr: ignored. librknnrt sends 0 here; the handle is authoritative.
 */
 ...
 * @task_obj_addr: zero-extended task GEM handle token.
 * @iommu_domain_id: iommu domain id
 * @reserved: just padding to be 64-bit aligned.
